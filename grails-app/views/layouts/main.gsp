...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" href="${resource(dir: 'css', file: 'calculator.css')}" type="text/css">
		<g:layoutHead/>
        <r:layoutResources />
	</head>
	<body>
		<div id="logo" class="header" role="banner">
			<a href="${request.contextPath}"><img src="${resource(dir: 'images', file: 'banner.png')}" width="710" height="55"/></a>
		</div>
		<g:layoutBody/>
